/**
 * OpenTelemetry + /health helpers for notification-service.
 *
 * notification-service does not depend on @callora/shared (it has its own
 * Dockerfile context), so this file is a self-contained copy of the shared
 * observability bootstrap. Keep it in sync with shared/src/observability/*.
 */

let otelStarted = false;

export function startOtel(serviceName = "notification-service"): void {
