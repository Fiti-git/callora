/**
 * Tenant-scoped audit-log writer for crm-service. Best-effort: never throws.
 * Mirrors backend/src/lib/audit.ts, restricted to TENANT_USER writes since
 * crm-service never serves platform-issued JWTs.
 */
...
export async function writeAuditLog(
  ...
  try {
    ...
    console.error("[crm-service] auditLog write failed:", err);
  }
}
